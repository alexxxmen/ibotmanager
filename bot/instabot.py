...
class InstaBot:
    ...
    def __init__(self,
        ...
        # hook for checking RUN parameter and cleanup wen change to False
        signal.signal(signal.SIGALRM, self.cleanup)
    ...
    def check_exisiting_comment(self, media_code):
        ...
        try:
            ...
            self.write_log(ex.message)
            self.write_log('Error during pars comment data=%s' % check_comment.text)
            raise
